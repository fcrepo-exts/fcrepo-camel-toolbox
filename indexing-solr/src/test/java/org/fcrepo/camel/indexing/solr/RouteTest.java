...
public class RouteTest extends CamelBlueprintTestSupport {
    ...
    public void testUpdateRouter() throws Exception {
        ...
        getMockEndpoint("mock:http4:localhost:8983/solr/fcrepo/update").expectedMessageCount(1);
        //getMockEndpoint("mock:http4:localhost:8983/solr/fcrepo/update")
            //.expectedHeaderReceived(Exchange.CONTENT_TYPE, "application/json");
        getMockEndpoint("mock:http4:localhost:8983/solr/fcrepo/update")
            .expectedHeaderReceived(Exchange.HTTP_METHOD, "POST");
        getMockEndpoint("mock:http4:localhost:8983/solr/fcrepo/update").expectedBodiesReceived(body);
